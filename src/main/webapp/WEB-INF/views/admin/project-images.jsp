                                    ...
                                    <table class="table table-bordered table-striped col-lg-12 col-sm-6 ">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button onclick="deletProject(${project.getId()})"
                                       ...
                                       <c:forEach var="image" items="${images}">
                                         <div class="col-lg">
                                           <img class="img-thumbnail"
                                            src="${pageContext.request.contextPath}/img/project/show/${image.getImageName()}"/>
...
<form id="deleteFormImage" method="POST" action="${pageContext.request.contextPath}/admin/project/image/delete">
    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
...
<!-- Modal -->
<!-- Modal -->
 <sprfrm:form role="form" action="${pageContext.request.contextPath}/admin/project/image/save"
       method="post"
