                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="container-fluid">
                                    <a href="${pageContext.request.contextPath}/admin/slider/add"
                                        ...
                                        <c:forEach var="slider" items="${sliders}">
                                            <tr>
                                               ...
                                               <%-- <td><c:out value="${slider.getImage()}"/></td>--%>
                                                <td>
                                                    <div class="thumbnail">
                                                        <img src="${pageContext.request.contextPath}/img/slider/show/${slider.getImage()}"/>
                                                    </div>
                                                </td>
                                                <td><c:out value="${slider.getTitle()}"/></td>
                                                <td><c:out value="${slider.getText()}"/></td>
                                                   <td><c:out value="${slider.getTitleAz()}"/></td>
                                                   <td><c:out value="${slider.getTextAz()}"/></td>
                                                <td><c:out value="${slider.getIsActive()}"/></td>
                                                <td><c:out value="${slider.getCreatedAt()}"/></td>
                                                <td><c:out value="${slider.getUpdatedAt()}"/></td>

                                                <td>
                                                    <a href="${pageContext.request.contextPath}/admin/slider/edit/${slider.getId()}"
                                                       class="btn btn-warning ">
                                                        <i class="fas fa-edit" ></i>  Edit
                                                    </a>
                                                    <a href="${pageContext.request.contextPath}/admin/slider/delete/${slider.getId()}"
