                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="container-fluid">
                                    <a href="${pageContext.request.contextPath}/admin/certificate/add"
                                    ...
                                    <table class="table table-bordered table-striped col-lg-12 col-sm-6 ">
                                        ...
                                        <c:forEach var="certificate" items="${certificates}">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="thumbnail">
                                                        <img src="${pageContext.request.contextPath}/img/certificate/show/${certificate.getImage()}"/>
                                                    </div>
                                                </td>

                                                <td><c:out value="${certificate.getText()}"/></td>
                                                <td><c:out value="${certificate.getIsActive()}"/></td>
                                                <td><c:out value="${certificate.getCreatedAt()}"/></td>
                                                <td><c:out value="${certificate.getUpdatedAt()}"/></td>

                                                <td>
                                                    <a href="${pageContext.request.contextPath}/admin/certificate/edit/${certificate.getId()}"
                                                       class="btn btn-warning ">
                                                        <i class="fas fa-edit" ></i>  Edit
                                                    </a>
                                                    <a href="${pageContext.request.contextPath}/admin/certificate/delete/${certificate.getId()}"
