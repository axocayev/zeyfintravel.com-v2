                    ...
                    <div class="col-lg-12 col-sm-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <sprfrm:form role="form" action="${pageContext.request.contextPath}/admin/scope/save"
                                             method="POST"         modelAttribute="scope" enctype="multipart/form-data">
                                    <input type="hidden"  name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                        ...
                                        <p>
                                            Name-EN:<sprfrm:input path="scopeName" id="scopeName"
                                                          class="form-control" placeholder="Scope Name"/>
                                        </p>
                                    ...
                                    <p>
                                        Name-AZ:<sprfrm:input path="scopeNameAz" id="scopeName"
                                                              class="form-control" placeholder="Scope Name"/>
                                    </p>
