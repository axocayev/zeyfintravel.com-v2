                    ...
                    <div class="col-lg-12 col-sm-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <sprfrm:form role="form"
                                             action="${pageContext.request.contextPath}/admin/slider/save"
                                             method="POST" modelAttribute="slider" enctype="multipart/form-data">
                                    ...
                                    <p>
                                        <sprfrm:hidden path="image"
                                                       class="form-control"/>
                                    </p>
                                    <p>
                                        Title-EN<sprfrm:input path="title" id="title"
                                                      class="form-control" placeholder="Title EN"/>
                                    </p>
                                    <p>
                                        Text-EN<sprfrm:input path="text" id="text"
                                                      class="form-control" placeholder="Text EN"/>
                                    </p>

                                    <p>
                                       Title-AZ <sprfrm:input path="titleAz" id="title"
                                                      class="form-control" placeholder="Title AZ"/>
                                    </p>
                                    <p>
                                       Text-AZ <sprfrm:input path="textAz" id="text"
                                                      class="form-control" placeholder="Text AZ"/>
                                    </p>
                                    ...
                                    <div class="container-fluid">
                                        <input type="submit"
                                                class="btn btn-success btn btn-success w-25 p-2"
                                               value="${button}">
