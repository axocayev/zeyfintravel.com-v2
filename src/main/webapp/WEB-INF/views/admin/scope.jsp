                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="container-fluid">
                                    <a href="${pageContext.request.contextPath}/admin/scope/add"
                                    ...
                                    <table class="table table-bordered table-striped col-lg-12 col-sm-6 ">
                                        ...
                                        <c:forEach var="scope" items="${scopeList}">
                                            <tr>
                                                ...
                                                <td><c:out value="${scope.getScopeNameAz()}"/></td>
                                                <td><c:out value="${scope.getContentAz()}"/></td>
                                                ...
                                                <td>
                                                    ...
                                                    <button onclick="deletProject(${scope.getId()})" class="btn btn-danger"/>
                                                    <i class="fas fa-trash" ></i>Delete</button>

                                                    <a class="btn btn-info"
                                                       href="${pageContext.request.contextPath}/admin/scope/${scope.getId()}/images">
