...
<head>
    ...
    <!-- Site Title -->
    <title><spring:message  code="navbar.about"/></title>
    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="#"><spring:message  code="navbar.home"/> </a> <span class="fa fa-home"></span>
                    <a href="#"> <spring:message  code="navbar.about"/></a></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 info-left">
                <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/info-img.jpg" alt="">
            </div>
            <div class="col-lg-6 info-right">

                <h1>Who We Are?</h1>
                <p>
                    Zeyfin Travel was established in 2018 as company and it is part of Zeyfin Group. From our
                    establishment we started to grow as one of most popular, strong travel companies in Azerbaijan and
                    that is why we have deep relations and corporate rates with hotel, restaurants and other impotant
                    places. Quality of company depends on its service, relations and we rely on our quality. Although we
                    are young company we have acces to domestic and foreign services and improwe day by day.
                </p>
                <h1>SERVICES:</h1>
                <p>
                    Airline Tickets<br>
                ...
                <hr>
                <a href="${pageContext.request.contextPath}/resources/doc/Zeyfin_Travel_brosur_3.pdf">Full Catalog</a>
